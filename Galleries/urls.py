...
urlpatterns = [
    ...
    path('gallery_profile_edit/', views.gallery_profile_edit, name='gallery_profile_edit'),
    path('gallery_event_upload/', views.gallery_event_upload, name='gallery_event_upload'),
]